 ...
 * @author Karen
 */
public class jF_evenementZoeken extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jF_evenementZoeken.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
